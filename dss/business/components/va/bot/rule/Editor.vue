    ...
    >
      <template #default="scope">
        <div class="flex flex-col gap-2">
          ...
          <el-form-item>
            <el-checkbox
              v-model="scope.current.conversation_start"
              :label="t('Only_applies_at_the_beginning_of_a_conversation')"
              size="large"
            />
            <el-checkbox
              v-model="scope.current.wait_for_user_input"
              :label="t('Wait_for_user_input')"
              size="large"
            />
          </el-form-item>
          <el-form-item
            ...
            label-width="10px"
          >
            <span class="w-full">{{ t('Rule_steps_guideline') }}</span>
            <StepsEditor
